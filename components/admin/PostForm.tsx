    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6 max-w-3xl">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          required
          rows={3}
          className="rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3.5 py-2.5 text-sm text-[var(--text-primary)] outline-none focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent)]/20 transition-colors resize-none"
